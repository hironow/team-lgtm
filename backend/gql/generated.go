...
type TodoResolver interface {
	User(ctx context.Context, obj *todo.Todo) (*User, error)
}
...
func (ec *executionContext) _Query_todos(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNTodo2ᚕgithubᚗcomᚋhironowᚋteamᚑlgtmᚋbackendᚋtodoᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *todo.Todo) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNUser2ᚖgithubᚗcomᚋhironowᚋteamᚑlgtmᚋbackendᚋgqlᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNTodo2ᚕgithubᚗcomᚋhironowᚋteamᚑlgtmᚋbackendᚋtodoᚐTodo(ctx context.Context, sel ast.SelectionSet, v []todo.Todo) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTodo2githubᚗcomᚋhironowᚋteamᚑlgtmᚋbackendᚋtodoᚐTodo(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋhironowᚋteamᚑlgtmᚋbackendᚋgqlᚐUser(ctx context.Context, sel ast.SelectionSet, v User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋhironowᚋteamᚑlgtmᚋbackendᚋgqlᚐUser(ctx context.Context, sel ast.SelectionSet, v *User) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
